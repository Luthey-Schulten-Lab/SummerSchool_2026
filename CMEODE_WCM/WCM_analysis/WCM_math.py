...
def truncate_time_series(time_end, array, time_dim):
    """
    time_dim: the index of the dimension of time
    """

    if time_dim == 0:
        value = array[0:time_end]
    elif time_dim == 1:
        value = array[:, 0:time_end]
    elif time_dim == 2:
        value = array[:, :, 0:time_end]
    else:
        raise ValueError("Invalid Index of the dimension of time for the input array")
