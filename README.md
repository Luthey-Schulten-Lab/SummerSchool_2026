...
<table>
  ...
  <tr>
    ...
    <td><sub>Alek Aksimentiev (612 IGB)</sub></td>
...
Jupyter tutorials run on the **QCB Delta Gateway**. Full setup — SSH tunnel, login, resource allocation, and cloning this repo — is in **[QCB_Gateway_setup.md](QCB_Gateway_setup.md)**.
